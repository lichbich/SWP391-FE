    ...
    <div class="main-container">
      <div class="container main-area">
            ...
            <div class="product-item" v-for="p in cartList" :key="p.id">
              ...
              <div class="product-info">
                ...
                <div class="product-vendor">
                  <span class="price"
                    >Price: {{ $filters.toDollarFormat(p.pPrice) }}</span
                  >
                ...
                <div class="product-total">
                  ...
                  <span class="total-text">{{
                    $filters.toDollarFormat(p.quantity * p.pPrice)
                  }}</span>
                </div>
              </div>
            </div>
        ...
        <div class="cart-total-area">
          ...
          <div class="btn checkout-btn" @click="showBillingAddressForm">
            Place Order
          </div>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    async onOrder(data) {
      ...
      formData.product = this.cartList;
